...
const int AUDIO_PIN = 2;  // Audio amplifier pin
...
// Function to create beeps and handle the sequence
...
void startMotors(int speed) {
    // For standard hardware, use analogWrite
...
// To create a better beep sound, you can use this function instead of just HIGH/LOW
// But it requires a dedicated pin that can be toggled very fast
void beepTone(int pin, int frequency, int duration) {
